...
<div className="w-full sm:w-8/12 md:w-10/12 lg:w-8/12 h-5/6  flex justify-evenly flex-col items-center">
    <div className="w-full h-24   flex justify-center md:justify-start  md:items-start items-center">
    <h1 className="text-[#C1506D]  font-semibold font-sans text-2xl  md:text-center md:text-2xl  pl-5     ">Welcome Back !</h1>
    </div>
    ...
    <button className="w-full h-10 border border-[#C1506D] bg-[#C1506D] rounded-md    text-white font-sans   font-bold text-sm  ">Sign In</button>
